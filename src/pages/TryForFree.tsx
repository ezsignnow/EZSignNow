        ...
        <div className="z-10 pt-8 mt-8 border-t border-white/5 max-w-xl mx-auto w-full overflow-hidden select-none">
          ...
          <div className="flex gap-8 whitespace-nowrap opacity-60 relative w-full overflow-hidden">
            <div className="flex gap-8 justify-around items-center min-w-full animate-[marquee_20s_linear_infinite] flex-shrink-0">
              <BrandLogoImg src={logoDevUrl(BRAND_DOMAINS.chegg, 40)} alt="Chegg" className="h-5 w-auto object-contain" fallback={<span className="text-xs font-extrabold text-white tracking-tight">Chegg</span>} />
              <BrandLogoImg src={logoDevUrl(BRAND_DOMAINS.stateFarm, 40)} alt="State Farm" className="h-5 w-auto object-contain" fallback={<span className="text-xs font-extrabold text-red-500 tracking-tight flex items-center gap-1"><span className="h-1.5 w-1.5 rounded-full bg-red-500"></span>StateFarm</span>} />
              <span className="text-xs font-extrabold text-white tracking-tight">COMPASS</span>
              <BrandLogoImg src={logoDevUrl(BRAND_DOMAINS.harvard, 40)} alt="Harvard" className="h-5 w-auto object-contain" fallback={<span className="text-xs font-extrabold text-white tracking-tight font-serif">HARVARD</span>} />
              <BrandLogoImg src={logoDevUrl(BRAND_DOMAINS.lernerRowe, 40)} alt="Lerner & Rowe" className="h-5 w-auto object-contain" fallback={<span className="text-xs font-extrabold text-white tracking-tight font-sans">LERNER&ROWE</span>} />
            </div>
