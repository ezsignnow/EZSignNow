...
// Cloud and integration icons — sourced from logo.dev by company domain
const GoogleDriveIcon = () => (
  <img src={logoDevUrl(BRAND_DOMAINS.googleDrive, 48)} alt="Google Drive" className="h-6 w-6 shrink-0 object-contain" />
);

const OneDriveIcon = () => (
  <img src={logoDevUrl(BRAND_DOMAINS.oneDrive, 48)} alt="OneDrive" className="h-6 w-6 shrink-0 object-contain" />
);

const DropboxIcon = () => (
  <img src={logoDevUrl(BRAND_DOMAINS.dropbox, 48)} alt="Dropbox" className="h-6 w-6 shrink-0 object-contain" />
);
