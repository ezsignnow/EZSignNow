...
// falling back to a hand-drawn SVG if the fetch is blocked (ad-blockers
// commonly flag domain-logo-lookup services) or otherwise fails.
const GoogleDriveIcon = () => (
  <BrandLogoImg
    src={logoDevUrl(BRAND_DOMAINS.googleDrive, 48)}
    alt="Google Drive"
...
const OneDriveIcon = () => (
  <BrandLogoImg
    src={logoDevUrl(BRAND_DOMAINS.oneDrive, 48)}
    alt="OneDrive"
    className="h-6 w-6 shrink-0 object-contain"
    fallback={
...
const DropboxIcon = () => (
  <BrandLogoImg
    src={logoDevUrl(BRAND_DOMAINS.dropbox, 48)}
    alt="Dropbox"
    className="h-6 w-6 shrink-0 object-contain"
    fallback={
      <svg viewBox="0 0 256 256" className="h-6 w-6 shrink-0">
